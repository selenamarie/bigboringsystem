...
exports.update = function (request, reply) {
  ...
  db.get('user!' + phone, function (err, user) {
    ...
    var userData = {
      name: name,
      websites: utils.autoLink(request.payload.websites),
      bio: utils.autoLink(request.payload.bio),
...
exports.get = function (phone, next) {
  db.get('user!' + phone, function (err, user) {
    ...
    user.websites = utils.autoLink(user.websites);
    user.bio = utils.autoLink(user.bio);
