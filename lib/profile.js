...
exports.update = function (request, reply) {
  ...
  db.get('user!' + phone, function (err, user) {
    ...
    var userData = {
      name: name,
      websites: utils.autoLink(Hoek.escapeHtml(request.payload.websites)),
      bio: utils.autoLink(Hoek.escapeHtml(request.payload.bio)),
...
exports.get = function (phone, next) {
  db.get('user!' + phone, function (err, user) {
    ...
    user.websites = utils.autoLink(Hoek.escapeHtml(user.websites));
    user.bio = utils.autoLink(Hoek.escapeHtml(user.bio));
